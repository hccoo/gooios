    ...
    var createBox = function ($fileInput, file, webUploader) {
        ...
        var li = '<li id="fileBox_' + file_id + '" class="diyUploadHover"> \
					<div class="viewThumb">\
					    ...
					    <p class="diyControl"><span class="diyLeft"><i></i></span><span class="diyCancel" filename="'+ fileName + '" onclick="removeEvt(this)" ><i></i></span><span class="diyRight"><i></i></span></p>\
					</div> \
				</li>';
