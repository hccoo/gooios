...
namespace Gooios.GoodsService.Domains.Events
{
    ...
    public abstract class DomainEvent : IDomainEvent
    {
            ...
            where TDomainEvent : class, IDomainEvent
        {
            ...
            {
                IEnumerable<IDomainEventHandler<TDomainEvent>> handlers = scope.Resolve<IEnumerable<IDomainEventHandler<TDomainEvent>>>(); //IocProvider.GetServices<IDomainEventHandler<TDomainEvent>>();// ServiceLocator.Instance.ResolveAll<IDomainEventHandler<TDomainEvent>>();
